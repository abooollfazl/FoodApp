...
public partial class UserMainPage : ContentPage
{
    ...
    private MealPlan? _currentPlan;  // ✅ nullable شد
    ...
    private async void OnLoadClicked(object? sender, EventArgs e)  // ✅ object? شد
    {
        var user = AuthService.GetCurrentUser();
        if (user == null) return;  // ✅ null check اضافه شد
        ...
        if (_currentPlan == null)  // ✅ null check اضافه شد
        {
            StatusLabel.Text = "خطا در بارگذاری جیره";
            return;
        }
    ...
    private async void OnGoToChatClicked(object? sender, EventArgs e)  // ✅ object? شد
    {
