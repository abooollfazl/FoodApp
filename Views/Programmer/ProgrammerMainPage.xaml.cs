...
public partial class ProgrammerMainPage : ContentPage
{
    ...
    private async void OnManageUsersClicked(object? sender, EventArgs e)  // ✅ object? شد
    {
        await Navigation.PushAsync(new ManageUsersPage());
    }

    private async void OnViewAllPlansClicked(object? sender, EventArgs e)  // ✅ object? شد
    {
        await Navigation.PushAsync(new Views.Manager.ManagerMainPage());
    }

    private async void OnMyPlanClicked(object? sender, EventArgs e)  // ✅ object? شد
    {
